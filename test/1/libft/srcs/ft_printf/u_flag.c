...
/*   Updated: 2016/09/26 19:30:18 by acoupleu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	print_nminus(char *un_int, int len, t_flag *f, t_env *env)
{
...
void		do_uinteger(unsigned long long d, t_flag *f, t_env *env, char c)
{
	int		len;
	char	*un_int;
